...
import com.anton111111.vr.VectorUtil;
...
public class Triangle {
     ...
     * @param far
     * @param T
     * @param I    output for intersection point
     * @return 0 = disjoint (no intersect); 1 = intersect in unique point I; 2 = are in the same plane
     */
